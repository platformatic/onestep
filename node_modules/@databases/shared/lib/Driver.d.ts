...
export default interface Driver<TTransactionOptions, TQueryStreamOptions> {
    ...
    queryStream(query: SQLQuery, options: TQueryStreamOptions | undefined): AsyncGenerator<any, void, unknown>;
    shouldRetryTransactionFailure(options: TTransactionOptions | undefined, err: Error, errorCount: number): Promise<boolean>;
